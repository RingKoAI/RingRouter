  ...
  return (
    ...
    <main className="max-w-3xl mx-auto px-4 py-16">
      ...
      <div className="text-center mb-12">
        ...
        <h1 className="text-3xl font-bold tracking-tight mb-3">{siteName}</h1>
      ...
      <div className="flex flex-wrap justify-center gap-3">
        <a href="https://github.com/RingKoAI/RingRouter" target="_blank" rel="noreferrer"
          className="inline-flex items-center gap-1.5 min-h-[42px] px-5 rounded-xl text-sm font-medium bg-primary text-primary-foreground hover:bg-primary-dark transition-colors cursor-pointer whitespace-nowrap">
          GitHub <ArrowRight size={14} />
        </a>
        <a href="https://github.com/RingKoAI/RingRouter/blob/main/README.md" target="_blank" rel="noreferrer"
          className="inline-flex items-center gap-1.5 min-h-[42px] px-5 rounded-xl text-sm font-medium border border-border hover:bg-muted transition-colors cursor-pointer whitespace-nowrap">
